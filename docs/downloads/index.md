...
- <a href="/downloads/rules/templates/CLAUDE.md.template" download>通用 CLAUDE 模板</a>
...
- <a href="/downloads/skills-hooks/templates/settings-with-hooks.json" download>Settings with Hooks</a>
- <a href="/downloads/production-governance/templates/ai-task-risk-matrix.md.template" download>AI 风险分级模板</a>
