...
- <a href="/downloads/skills-hooks/templates/commands/fix-bug.md"><code>fix-bug.md</code></a> — bug 修复 Skill 教学模板
- <a href="/downloads/skills-hooks/templates/commands/gen-tests.md"><code>gen-tests.md</code></a> — 生成测试 Skill 教学模板
- <a href="/downloads/skills-hooks/templates/commands/review-code.md"><code>review-code.md</code></a> — 代码审查 Skill 教学模板
- <a href="/downloads/skills-hooks/templates/settings-with-hooks.json"><code>settings-with-hooks.json</code></a> — 带 Hook 的教学配置示例
- [`advanced-patterns.md`](./advanced-patterns.md) — Skill 进阶设计模式
- [`examples/skill-hook-decision-cases.md`](./examples/skill-hook-decision-cases.md) — Skill / Hook 选择示例
- <a href="/downloads/examples/minimal-agent-demo/.claude/commands/fix-bug.md"><code>Minimal Agent Demo 的 fix-bug Skill</code></a> — 项目级 Skill 演示
- <a href="/downloads/examples/minimal-agent-demo/.claude/commands/gen-tests.md"><code>Minimal Agent Demo 的 gen-tests Skill</code></a> — 项目级 Skill 演示
- <a href="/downloads/examples/minimal-agent-demo/.claude/commands/review-code.md"><code>Minimal Agent Demo 的 review-code Skill</code></a> — 项目级 Skill 演示
